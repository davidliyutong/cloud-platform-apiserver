...
@bp.post("/login", name="jwt_token_login", version=1)
@openapi.definition(
...
@bp.post("/refresh", name="jwt_token_refresh", version=1)
@openapi.definition(
    parameter=[
...
@bp.get("/validate/<username:str>", name="jwt_token_validate_user", version=1)
@openapi.definition(
    parameter=[
        openapi.definitions.Parameter(
